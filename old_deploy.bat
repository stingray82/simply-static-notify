...
SET "PLUGIN_NAME=Simply Static Export ^& Notify"
SET "PLUGIN_TAGS=simplystatic, automation, export, static"
SET "PLUGIN_SLUG=simply-static-export-notify"

SET "HEADER_SCRIPT=C:\Ignore By Avast\0. PATHED Items\Plugins\deployscripts\myplugin_headers.php"
SET "CHANGELOG_FILE=C:\Users\Nathan\Git\rup-changelogs\%PLUGIN_SLUG%.txt"
...
REM GitHub settings
SET "GITHUB_REPO=stingray82/simply-static-notify"
